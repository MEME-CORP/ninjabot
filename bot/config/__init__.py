...
class ConversationState:
    ...
    TOKEN_CREATION_PREVIEW = 46
    BUY_AMOUNTS_CONFIG = 47
    BUY_AMOUNTS_INPUT = 48
    BUY_AMOUNTS_PREVIEW = 49
    WALLET_BALANCE_CHECK = 50
    WALLET_FUNDING_REQUIRED = 51
    WALLET_FUNDING_PROGRESS = 52
    FINAL_TOKEN_CREATION = 53
    BUNDLE_OPERATION_PROGRESS = 54
    BUNDLE_OPERATION_COMPLETE = 55
