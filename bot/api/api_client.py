...
class ApiClient:
    ...
    def check_spl_swap_readiness(self, child_wallets: List[str], min_swap_amount_sol: float = 0.0001) -> Dict[str, Any]:
        ...
        aligned with documented funding constraints in cause_debugging.yaml.

        Strategy (Root‑Cause Fix Alignment):
        ...
        Args:
            ...
            min_swap_amount_sol: Smallest single swap amount planned.

        Returns:
            Dict containing readiness metadata.
        """
        try:
            ...
            return {
                "status": "ready",
                "child_wallets_count": wallet_count,
                "gas_reserve_per_wallet": gas_reserve_per_wallet,
                "min_swap_amount_sol": min_swap_amount_sol,
                "min_required_per_wallet": round(min_required_per_wallet, 9),
                "recommended_funding_total": round(min_required_per_wallet * wallet_count, 9)
            }
        except Exception as e:
